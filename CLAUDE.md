...
### Other Components
- **HelpCenter.tsx**: Searchable in-app documentation covering first-run guidance, external file-change notices, tabular workflows, multi-file tools, QC/history, JSON, Markdown, PDF, export, and shortcuts; available from the sidebar, welcome screen, collapsed sidebar, or F1
